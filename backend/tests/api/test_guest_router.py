...
class TestGuestUsage:
    ...
    def test_check_guest_usage_success(self, mock_settings, mock_get_usage):
    ...
    @patch("app.routers.guest.get_guest_usage_count")
    @patch("app.routers.guest.settings")
    def test_check_guest_usage_limit_reached(self, mock_settings, mock_get_usage):
    ...
    def test_use_guest_service_success(
        self, mock_settings, mock_increment, mock_get_usage
    ):
    ...
    @patch("app.routers.guest.get_guest_usage_count")
    @patch("app.routers.guest.settings")
    def test_use_guest_service_limit_reached(self, mock_settings, mock_get_usage):
