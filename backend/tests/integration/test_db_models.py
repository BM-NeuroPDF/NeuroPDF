...
class TestUserSettingsModel:
    ...
    def test_user_settings_relationship_user(self, test_db_session, clean_db, test_user):
...
class TestGuestSessionModel:
    ...
    def test_update_guest_session(self, test_db_session, clean_db):
        ...
        found = test_db_session.query(GuestSession).filter(GuestSession.id == session.id).first()
