...
class User(Base):
    ...
    auth_records = relationship("UserAuth", back_populates="user", cascade="all, delete-orphan")
...
class UserSettings(Base):
    ...
    eula_accepted: Mapped[bool] = mapped_column(Boolean, server_default='false', nullable=False)
