...
**AI destekli PDF işleme ve sohbet platformu.** Özetleme, birleştirme, sayfa çıkarma, düzenleme ve PDF üzerinde RAG tabanlı sohbet özellikleri sunar.
...
Tüm mimari, test raporları ve çıktı konumları **[docs/](docs/)** altında toplanmıştır.
...
Projede **Vitest** (frontend birim/entegrasyon), **Pytest** (backend & AI service) ve **Playwright** (E2E) testleri bulunur.
...
| Chat | PDF içeriği üzerinde RAG tabanlı soru-cevap (yerel veya bulut LLM) | Özetleme sonrası panel / global chat |
...
Daha detaylı mimari için: [docs/architecture/ARCHITECTURE.md](docs/architecture/ARCHITECTURE.md). Rapor ve log konumları: [docs/reports-and-outputs.md](docs/reports-and-outputs.md).
