...
function Harness(props: Partial<React.ComponentProps<typeof InputOTP6>>) {
  ...
  return <InputOTP6 value={value} onChange={setValue} aria-label="Test OTP" {...props} />;
}
...
describe('InputOTP6', () => {
  ...
  it('keeps the real OTP input focusable (no sr-only clipping)', () => {
    ...
    const input = container.querySelector('input[data-input-otp]') as HTMLInputElement | null;
