...
export default function AuthBar() {
  ...
  if (status === 'loading') {
    return (
      <div className="w-24 h-10 animate-pulse bg-[var(--container-bg)] rounded-xl opacity-50 border border-[var(--container-border)]"></div>
    );
  }
    ...
    return (
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-2 xl:px-3 py-2 rounded-xl transition-all duration-200
