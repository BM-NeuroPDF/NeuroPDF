...
export default function HomePage() {
  ...
  return (
    <main className="flex items-center justify-center min-h-[calc(100vh-var(--navbar-height))] w-full p-6 text-[var(--foreground)] relative overflow-hidden">
      <div
      ...
      >
        ...
        <p className="max-w-2xl text-lg opacity-80 leading-relaxed animate-in slide-in-from-bottom-5 duration-700 delay-100">
          {t('landingDescription') ||
            'PDF dosyalarınızı birleştirin, düzenleyin ve yapay zeka ile özetleyin. Hepsi tek bir yerde, hızlı ve güvenli.'}
        </p>
        ...
        {/* İSTATİSTİK GRID */}
        <div
          key={isPersonalMode ? 'personal' : 'global'}
          className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full mt-2 animate-in fade-in slide-in-from-bottom-2 duration-500"
        >
