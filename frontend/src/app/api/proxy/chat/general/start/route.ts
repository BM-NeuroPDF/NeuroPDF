...
export async function POST(req: Request) {
  try {
    ...
    const backendResponse = await fetch(`${backendBaseUrl}/files/chat/general/start`, {
      method: 'POST',
    ...
    const message =
      error instanceof Error ? error.message : 'Proxy request failed for /files/chat/general/start';
