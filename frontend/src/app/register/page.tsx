    ...
    <main className="min-h-screen flex items-center justify-center p-4 bg-[var(--background)] text-[var(--foreground)] transition-colors duration-300">
      ...
      {showEulaModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-2xl bg-[var(--container-bg)] rounded-2xl shadow-2xl flex flex-col max-h-[85vh] border border-[var(--navbar-border)]">
            {/* Modal Header */}
            <div className="p-6 border-b border-[var(--navbar-border)] flex justify-between items-center">
              ...
              <button
                ...
                className="text-2xl font-bold opacity-60 hover:opacity-100"
              >
                &times;
              </button>
            </div>
